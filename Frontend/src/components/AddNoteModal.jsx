          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
              <input
                ...
                required
                className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-xs font-semibold text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:border-slate-900 dark:focus:border-slate-600 shadow-2xs"
              />
              <textarea
                ...
                required
                rows={4}
                className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-xs font-medium text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:border-slate-900 dark:focus:border-slate-600 shadow-2xs resize-none"
              />
              ...
              {imagePreview ? (
                ...
                <label className="flex items-center justify-center gap-2 border border-dashed border-slate-300 dark:border-slate-700 rounded-xl p-3 text-xs font-medium text-slate-500 dark:text-slate-400 hover:border-slate-800 dark:hover:border-slate-400 hover:text-slate-800 dark:hover:text-slate-200 transition-colors cursor-pointer bg-slate-50/50 dark:bg-slate-800/40">
                  <LuImage size={16} />
              ...
              <button
                type="submit"
                disabled={submitting}
                className="bg-slate-950 dark:bg-slate-800 hover:bg-slate-800 dark:hover:bg-slate-700 text-white rounded-xl py-3 font-semibold text-xs mt-2 disabled:opacity-50 transition-colors cursor-pointer"
              >
