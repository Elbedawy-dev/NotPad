      ...
      <div>
        ...
        <main className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">{t("overviewSub")}</p>
          </div>
            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-6 shadow-xs flex flex-col justify-between">
                  ...
                  <div>
                    <p className="text-4xl font-bold text-slate-900 dark:text-white mb-1">{total}</p>
                    <p className="text-xs font-semibold text-slate-400 dark:text-slate-500">{t("totalNotes")}</p>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-6 shadow-xs flex flex-col justify-between">
                  ...
                  <div>
                    <p className="text-4xl font-bold text-slate-900 dark:text-white mb-1">{publicCount}</p>
                    <p className="text-xs font-semibold text-slate-400 dark:text-slate-500">{t("publicNotes")}</p>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-6 shadow-xs flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-xs text-slate-400 dark:text-slate-500 font-medium">{t("encrypted")}</span>
                  </div>
                  <div>
                    <p className="text-4xl font-bold text-slate-900 dark:text-white mb-1">{privateCount}</p>
                    <p className="text-xs font-semibold text-slate-400 dark:text-slate-500">{t("privateNotes")}</p>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-6 shadow-xs flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-xs text-slate-400 dark:text-slate-500 font-medium">{t("active")}</span>
                  </div>
                  <div>
                    <p className="text-4xl font-bold text-slate-900 dark:text-white mb-1">{thisWeekCount || 4}</p>
                    <p className="text-xs font-semibold text-slate-400 dark:text-slate-500">{t("thisWeek")}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h2 className="text-base font-bold text-slate-900 dark:text-white">{t("recentNotes")}</h2>
                    <p className="text-xs text-slate-400 dark:text-slate-500">{t("latestEntriesSub")}</p>
                  </div>
                  <button
                    onClick={() => navigate("/")}
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xs divide-y divide-slate-100 dark:divide-slate-800 overflow-hidden">
                  {recentNotes.length === 0 ? (
                    <p className="p-6 text-xs text-slate-400 dark:text-slate-500 text-center">{t("noNotesFound")}</p>
                  ) : (
                      ...
                      >
                        <div className="space-y-1">
                          <div className="flex items-center gap-2.5">
                            ...
                            >
                              {note.isPublic ? `• ${t("publicTag")}` : `🔒 ${t("privateTag")}`}
                            </span>
                          </div>
                        ...
                        <div className="flex items-center gap-3 shrink-0 ml-4">
                          ...
                          <LuChevronRight size={16} className="text-slate-300 dark:text-slate-600 group-hover:text-slate-600 dark:group-hover:text-slate-300 transition-colors" />
                        </div>
                      </div>
                    ))
                  )}
