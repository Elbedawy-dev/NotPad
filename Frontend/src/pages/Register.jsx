    ...
    <div className="min-h-screen bg-[#f6f6fb] flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-16">
        <motion.div
          ...
          className="w-full max-w-sm bg-white shadow-sm rounded-2xl p-6 sm:p-8 border 
          border-slate-100">
          {/* Header Section */}
          <div className="flex flex-col justify-center items-center mb-6 text-center">
            ...
            <p className="text-sm text-slate-400 mt-1">Start organizing your notes today</p>
          </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  placeholder="e.g. moaaz Jenkins"
                  className="w-full bg-slate-50 rounded-lg py-2.5 pl-10 pr-4 outline-none border 
                  border-slate-200 focus:border-black focus:bg-white text-slate-800 
                  transition-all text-sm"
                />
                <LuUser className="absolute left-3 text-slate-400 text-lg pointer-events-none" />
              </div>
            </div>
...
/>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-slate-50 rounded-lg py-2.5 pl-10 pr-10 outline-none border 
                  border-slate-200 focus:border-black focus:bg-white text-slate-800 
                  transition-all text-sm"
                />
                ...
                <button
                  ...
                  className="absolute right-3 text-slate-400 hover:text-slate-600 text-lg 
            ...
            <div className="w-full mt-2">
              <motion.button
                ...
                disabled={submitting}
                type="submit"
                className="cursor-pointer w-full bg-black hover:bg-slate-800 text-white 
                font-semibold rounded-lg px-4 py-2.5 transition-colors disabled:opacity-50"
              >
          ...
          <div className="flex justify-center items-center mt-6 text-sm text-slate-500">
            ...
            <Link to="/login" className="text-black hover:underline font-semibold ml-1">
              Log in
            </Link>
          </div>
        </motion.div>
